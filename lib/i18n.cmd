...
set "I18N_APPLY_TEMP=%TEMP%\proj_i18n_apply_%RANDOM%.cmd"
set "I18N_CLI_OVERRIDE="
if defined PROJECT_LANGUAGE set "I18N_CLI_OVERRIDE=%PROJECT_LANGUAGE%"

powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0i18n-export.ps1" -ScriptDir "%I18N_SCRIPT_DIR%" -CliOverride "%I18N_CLI_OVERRIDE%" -ApplyFile "%I18N_APPLY_TEMP%" 2>nul
